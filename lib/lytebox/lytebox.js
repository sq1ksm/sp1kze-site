// shim to disable clicks before a pageload 
// #tresc
if (window.addEventListener) {
	var disableClicking = function (e) {
		e.preventDefault()
	}
	document.querySelector("main").addEventListener("click", disableClicking);
	window.addEventListener("load", function () {
		document.querySelector("main").removeEventListener("click", disableClicking);
	});
}
